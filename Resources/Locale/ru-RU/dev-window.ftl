## Вкладка «Текстуры» окна разработчика

dev-window-tab-textures-title = Текстуры
dev-window-tab-textures-reload = Перезагрузить
dev-window-tab-textures-filter = Фильтр
dev-window-tab-textures-summary = Всего (примерно): { $bytes }
dev-window-tab-textures-info = Ширина: { $width } Высота: { $height }
    Тип пикселей: { $pixelType } sRGB: { $srgb }
    Имя: { $name }
    Примерный объём памяти: { $bytes }

## Вкладка «Целевые поверхности рендеринга» окна разработчика
dev-window-tab-render-targets-title = Целевые поверхности рендеринга
...
dev-window-tab-render-targets-value-not-available = Недоступно
dev-window-tab-render-targets-summary = Всего видеопамяти: { $vram }
